...
- **GitHub private disclosure:** Use the [Security tab](https://github.com/TadMSTR/ollama-queue-proxy/security/advisories/new) to submit a private advisory.
- **Email:** Send a description to `security.i9v75@8alias.com` with the subject line `[ollama-queue-proxy] Security Report`.
